...
/**
 * Check if user is Social Manager (sandboxed role for social inclusions only)
 */
export function isSocialManager(user: User | null | undefined): boolean {
  return hasRole(user, 'SOCIAL_MANAGER');
}
