// Simple sanitizer to prevent XSS attacks. Strips markup entirely — for plain
// string inputs (auth forms), not for content that must keep its HTML.
// To sanitize rich text while preserving markup, use lib/sanitize-article-html.
// Do not reach for isomorphic-dompurify: it pulls jsdom into the server bundle.
