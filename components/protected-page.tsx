...
export const ProtectionPresets = {
  ...
  SupportAccess: {
    requiredRoles: ['SUPER_ADMIN', 'ADMIN', 'CALENDAR_MEMBER', 'DINNING_MEMBER', 'SALES', 'AGENCY', 'EDITORIAL_WRITER'] as string[],
    requiredPermissions: ['support:read', 'support:manage'] as string[]
  },
};
